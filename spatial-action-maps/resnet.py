# Adapted from https://github.com/jimmyyhwu/spatial-action-maps/blob/master/resnet.py
...
class SteeringCommandsDQN(Module):
    def __init__(self, num_input_channels=3, num_output_channels=4):
        """
        num_output_channels: number of actions
        """
        super().__init__()
        self.resnet18 = resnet18(num_input_channels=num_input_channels, num_classes=num_output_channels)
