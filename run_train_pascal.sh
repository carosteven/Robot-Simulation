...
python DQL/train_pascal.py --state_type vision --num_epoch 50 --checkpoint_path $PWD/checkpoint/checkpoint_pascal.pt --checkpoint_interval 3600 --log_file  $PWD/train_p.log --batch_size 128 --environment 2