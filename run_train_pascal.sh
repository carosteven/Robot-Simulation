...
python DQL/train_pascal.py --state_type vision --num_epoch 50 --checkpoint_path $PWD/checkpoint/checkpoint_nav.pt --checkpoint_interval 3000 --log_file  $PWD/train_nav.log --batch_size 128 --environment 3