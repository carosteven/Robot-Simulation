...
python DQL/train_pascal.py --state_type vision --num_epoch 50 --checkpoint_path $PWD/checkpoint/checkpoint_push.pt --checkpoint_interval 3000 --log_file  $PWD/train_push.log --batch_size 64 --environment 2