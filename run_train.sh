...
python DQL/train.py --state_type vision --num_epoch 50 --checkpoint_path $PWD/checkpoint/checkpoint.pt --checkpoint_interval 3600 --log_file  $PWD/train.log --batch_size 64 --environment 1